...
<div id="searchContent" class=" well">
    <div class="controls controls-row" style="width: 69%; display: inline-block;">
        ...
        <div id="RouteIdsContainer" class="control-group form-group span6">
            <label>
                Rutas</label>
            <%:Html.DropDownList("RouteIds", new SelectList(new List<int>()), new { @class = "form-control multiselectize",
                id = "RouteIds", data_role = "none", @style=" width: 100%;", multiple="multiple" }) %>
        </div>
    </div>
