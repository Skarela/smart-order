<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<siteSmartOrder.Areas.RoutePreparation.Models.Contact>" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row-fluid" style="margin-bottom: 30px;">
        <div class="span8 offset2">
            ...
            <ul class="nav nav-tabs" id="tabconfig">
                <li><a href="<%:Url.Action("New","CoolerConfiguration", new{Area="RoutePreparation"})%>">Revisión de Enfriadores</a></li>  
            ...
            <% using (Html.BeginForm("Update", "Contact", FormMethod.Post, new { id = "Form", enctype = "multipart/form-data" }))
               { %>
                <div class="tab-pane active">
                    <% Html.RenderPartial("_Form", Model); %>
                </div>
                <%= Html.ButtonsForm(Url.Action("Index", "Contact", new {Area = "RoutePreparation"}), false) %>
            <% } %>
        </div>
    </div>
    ...
    <script type="text/javascript" src="<%:Url.Content("~/Areas/RoutePreparation/Content/Scripts/Contact/Form.js")%>" defer></script>
