...
<div id="searchContent" class=" well">
    <div class="controls controls-row" style="width: 69%; display: inline-block;">
        <div id="UnitIdsContainer" class="control-group form-group span6">
            <label>
                Unidades</label>
            <%:Html.DropDownList("UnitIds", new SelectList(new List<int>()), new { @class = "form-control multiselectize",
                id = "UnitIds", data_role = "none", @style=" width: 100%;", multiple="multiple" }) %>
        </div>
        <div id="MechanicIdsContainer" class="control-group form-group span6">
            <label>
                Mecánicos</label>
            <%:Html.DropDownList("MechanicIds", new SelectList(new List<int>()), new { @class = "form-control multiselectize",
                id = "MechanicIds", data_role = "none", @style=" width: 100%;", multiple="multiple" }) %>
        </div>
    </div>
