    ...
    <div class="row-fluid" style="margin-bottom: 30px;">
        <div class="span8 offset2">
            ...
            <ul class="nav nav-tabs" id="tabconfig">
                ...
                <li class="active"><a>Editar Alerta</a></li>           
            ...
            <% using (Html.BeginForm("Update", "Alert", FormMethod.Post, new { id = "Form", enctype = "multipart/form-data" }))
            { %>
                <div class="tab-pane active">
                    <% Html.RenderPartial("_Form", Model); %>
                </div>
                <%= Html.ButtonsForm(Url.Action("Index", "Alert", new {Area = "RoutePreparation"}), false) %>
            <% } %>
        </div>
    </div>
