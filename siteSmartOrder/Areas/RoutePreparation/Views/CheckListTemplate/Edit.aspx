    ...
    <div class="row-fluid" style="margin-bottom: 30px;">
        <div class="span8 offset2">
            ...
            <ul class="nav nav-tabs" id="tabconfig">
                <li><a href="<%:Url.Action("Index","ChecklistReply", new{Area="RoutePreparation"})%>">Revisiones de Unidad</a></li>
            ...
            <% using (Html.BeginForm("Update", "CheckListTemplate", FormMethod.Post, new { id = "Form", enctype = "multipart/form-data" }))
               { %>
