...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    Nueva Plantilla de Concientización
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row-fluid" style="margin-bottom: 30px;">
        <div class="span8 offset2">
            ...
            <% using (Html.BeginForm("Create", "CampaignTemplate", FormMethod.Post, new { id = "Form", enctype = "multipart/form-data" }))
               { %>
                ...
                <%= Html.ButtonsForm(Url.Action("Index", "CampaignTemplate", new {Area = "RoutePreparation"}), true) %>
            <% } %>
        </div>
    </div>
