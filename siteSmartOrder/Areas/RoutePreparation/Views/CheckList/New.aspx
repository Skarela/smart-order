...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row-fluid" style="margin-bottom: 30px;">
        <div class="span8 offset2">
            ...
            <h3>Revisión de Unidad (Nueva)</h3>


            <% Html.RenderPartial("_Alerts"); %>

            <% using (Html.BeginForm("Create", "CheckList", FormMethod.Post, new { id = "Form", enctype = "multipart/form-data" }))
               { %>


            <div class="tab-pane active">

                <%: Html.Partial("_Branches") %>
            ...
            <button id='Create' type='submit' class='btn btn-success' name="submitBtn" value="crear">Crear</button>
            <% } %>
        </div>
    </div>
