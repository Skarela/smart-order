    ...
    <div class="row-fluid" style="margin-bottom: 30px;">
        <div class="span8 offset2">
            ...
            <ul class="nav nav-tabs" id="tabconfig">
                ...
                <li class="active"><a>Editar Contacto</a></li>         
            </ul>
        
            <h3>Editar Contacto</h3>
            <% Html.RenderPartial("_Alerts"); %>
            
            <% using (Html.BeginForm("Update", "Manager", FormMethod.Post, new { id = "Form", enctype = "multipart/form-data" }))
               { %>
                ...
                <%= Html.ButtonsForm(Url.Action("Index", "Manager", new {Area = "RoutePreparation"}), false) %>
            <% } %>
        </div>
    </div>
