...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row-fluid" style="margin-bottom: 30px;">
        <div class="span8 offset2">
            ...
            <ul class="nav nav-tabs" id="tabconfig">
                ...
                <li class="active"><a>Tipos de siniestros</a></li>
            ...
            <h3>Lista de Tipos de Siniestros  <%= Html.ButtonExport() %> </h3>
    ...
    <script type="text/javascript" src="<%:Url.Content("~/Areas/RoutePreparation/Content/Scripts/Incident/Index.js")%>" defer></script>
