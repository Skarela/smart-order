    ...
    <div class="row-fluid" style="margin-bottom: 30px;">
        <div class="span8 offset2">
            ...
            <ul class="nav nav-tabs" id="tabconfig">
                ...
                <li><a href="<%:Url.Action("New","CoolerConfigurationTemplate", new{Area="RoutePreparation"})%>">Nueva Plantillas</a></li>         
            </ul>
        
            <h3>Revisión de Enfriador (Editar)</h3>
            <% Html.RenderPartial("_Alerts"); %>
            
            <% using (Html.BeginForm("Update", "CoolerConfiguration", FormMethod.Post, new { id = "Form", enctype = "multipart/form-data" }))
               { %>
