...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row-fluid" style="margin-bottom: 30px;">
        <div class="span8 offset2">
            ...
            <ul class="nav nav-tabs" id="tabconfig">
                ...
                <li class="active"><a>Nueva Configuración</a></li>
            ...
            <h3>Revisión de Enfriador (Nuevo)</h3>
            <% Html.RenderPartial("_Alerts"); %>

            <% using (Html.BeginForm("Create", "CoolerConfiguration", FormMethod.Post, new { id = "Form", enctype = "multipart/form-data" }))
               { %>
    ...
    <script type="text/javascript" src="<%:Url.Content("~/Areas/RoutePreparation/Content/Scripts/CoolerConfiguration/Form.js?v=1.1")%>" defer></script>
    <script type="text/javascript" src="<%:Url.Content("~/Areas/RoutePreparation/Content/Scripts/Survey/Form.js?v=1.1")%>" defer></script>
    <script type="text/javascript" src="<%:Url.Content("~/Areas/RoutePreparation/Content/Components/MultiSelectize/sol.js?v=1.1")%>" defer></script>
</asp:Content>
