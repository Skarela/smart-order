...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    Editar Campaña de Concientización
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row-fluid" style="margin-bottom: 30px;">
        <div class="span8 offset2">
            ...
            <% using (Html.BeginForm("Update", "Campaign", FormMethod.Post, new { id = "Form", enctype = "multipart/form-data" }))
               { %>
                ...
                <%= Html.ButtonsForm(Url.Action("Index", "Campaign", new { Area = "RoutePreparation" }), false)%>
            <% } %>
        </div>
    </div>
    ...
    <script type="text/javascript" src="<%:Url.Content("~/Areas/RoutePreparation/Content/Scripts/Campaign/Form.js?v=1.1")%>" defer></script>
    ...
    <script type="text/javascript" src="<%:Url.Content("~/Areas/RoutePreparation/Content/Scripts/Campaign/Edit.js?v=1.1")%>" defer></script>
