...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <link rel="stylesheet" href="<%:Url.Content("~/Content/Selectize/Css/Selectize.min.css")%>"/>
    ...
    <div class="row-fluid" style="margin-bottom: 30px;">
        <div class="span8 offset2">
            ...
            <h3>Lista de campañas  <%= Html.ButtonExport() %> </h3>
            <% Html.RenderPartial("_Alerts"); %>

            <div class="tab-pane active">
                <% Html.RenderPartial("_Filters"); %>
                <% Html.RenderPartial("_EditDatesModal"); %>
    ...
    <script type="text/javascript" src="<%:Url.Content("~/Content/Selectize/Scripts/Selectize.min.js?v=1.1")%>" defer></script>
    ...
    <script type="text/javascript" src="<%:Url.Content("~/Areas/RoutePreparation/Content/Scripts/Campaign/Index.js?v=1.1")%>" defer></script>
