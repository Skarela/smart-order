    ...
    public class ClienteController : Controller
    {
        ...
        // GET: /Cliente/
         ...
         public JsonResult Paginacion(string page,string branchId,string filter) {
            ...
            var request = new RestRequest("Customer/All?page={page}&num={num}&filter={filter}", Method.POST);
         ...
         public JsonResult Paginacion_(string page, string branchId, string filter)
         {
             ...
             var res = jss.Deserialize<Response<TableObject<List<Customer>>>>(content);
