...
{
    public partial class CustomerScannedReport : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
             ...
             if (UserPortal != null)
             {
                 if (!Page.IsPostBack)
                 {
                     ...
                     string sReportPath = ConfigurationManager.AppSettings["ReportPath"].ToString() + "/WBC_SO_Rep_CustomerScanned";
